    ...
    <div class="material-group-panel" data-panel-group="white">
      ...
      <div class="material-card-group material-card-group-inner" data-material-group="white" style="display:none;">
        ...
        <button type="button" class="material-card" data-value="pearlescent">
          <img src="https://img.1shop.tw/yLd7jOJbP0DvggQRxo8kq1QB/Gr1Lb8a63ZLXBb7wNEAXx24D/original.jpg" class="material-card-img" alt="冷凍防水珠光貼紙示意圖" loading="lazy">
        ...
        <button type="button" class="material-card" data-value="normalPearlescent">
          <img src="https://img.1shop.tw/yLd7jOJbP0DvggQRxo8kq1QB/Gr1Lb8a63ZLXBb7wNEAXx24D/original.jpg" class="material-card-img" alt="一般防水珠光貼紙示意圖" loading="lazy">
...
</div><div class="form-row row-2"><div><label for="quantity">數量：</label><select id="quantity"><option value="100">100</option><option value="300">300</option><option value="500">500</option><option value="1000">1000</option><option value="2000">2000</option></select></div><div>
  <label for="urgent">升級急件：</label>
  <select id="urgent">
...
async function saveDesignToGAS(){
  ...
  // v7.9.15 關鍵修正：
  // 這裡只做出血風險確認，不產生圖檔 payload。
  // 圖檔必須在每次 runSaveAttempt() 內重新產生，避免印刷檔吃到舊 canvas / 切割檔。
  try{
    if(typeof window.lunyConfirmBleedBeforeSave === "function"){
      ...
      console.warn("[LUNY] lunyConfirmBleedBeforeSave 尚未載入，請確認預覽主程式已更新至 v7.9.13。");
    }
  }catch(err){
...
<script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool/luny-preview-editor-v7.9.4.js?v=20260609-2"></script>
<script>
/* LUNY inline full-bleed patch v7.9.13 - integrated into HTML to avoid extra patch file loading */
...
<script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool/luny-pricing-table-v35-1.js"></script>
<script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool/luny-price-engine-v35-1.js"></script>
