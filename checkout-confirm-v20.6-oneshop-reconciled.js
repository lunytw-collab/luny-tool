 ...
 * Version: 2026-09-04.20.6
 * Load at the original checkout-confirm script position without async/defer.
 */
window.__LUNY_CHECKOUT_CONFIRM_CART_READY_FIX_V206__ = "2026-09-04.20.6-full";
...
function beginCheckoutLaunchMonitor(){
  ...
  checkoutLaunchMonitorTimer = setInterval(function(){
    ...
    const targetProductId = String(routeParams.ID || routeParams.id || "").trim();
    ...
    const matchingCartSyncState = !!(
      ...
      expectedTotal > 0 &&
      targetProductId === "N6qx3aVnzXNaKbO87jZWBXY2" &&
      cartSyncState &&
