 ...
 * 6. v20.4：Token 衝突時停止重送，但只以 1SHOP 查詢結果判定正式訂單
 */
...
const CHECKOUT_TOKEN_BOUND_PREFIX = "LUNY_CHECKOUT_TOKEN_BOUND_V1::";
...
const LUNY_V17_VERSION = "2026-08-26.20.4";
...
function LUNY_V17_markTokenBound(token, error){
  ...
  const marker = {
    ...
    orderState:"ONESHOP_ORDER_NOT_CONFIRMED",
...
function LUNY_V17_renderTokenBoundState(marker){
  ...
  getCheckoutActionButtons().forEach(function(button){
    ...
    button.textContent = "對帳編號待核對｜停止重送";
  });
