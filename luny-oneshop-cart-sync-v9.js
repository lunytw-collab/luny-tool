...
(function installLunyOneShopCartV9(){
  ...
  window.__LUNY_ONESHOP_CART_ABSOLUTE_V9__ = "2026-08-06.1";
  ...
  async function verifyAbsoluteCart(){
    ...
    window.alert("付款商品金額同步失敗，系統已停止結帳。請重新按一次「選購」與「加入購物車」。");
    return false;
  }
  ...
  async function reconcileInitialCart(){
    if(initialReconciled || initialReconcileFlight || !isTargetProductPage()) return;
