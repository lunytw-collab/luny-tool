/* LUNY 預覽主程式整合版 v7.9.20-color-option-shadow-preview
 ...
 * v7.9.20：新增「滿版底色 / 邊框顏色」同層級選項；預覽改為成品遮罩＋陰影；保留白邊 / 滿版底色模式不顯示危險區域。
 */
...
function applyMirrorBleedFromCutLine(ctx,canvas,cm2px){
  ...
  if(isMirrorBleedEdgeMode()){
    ...
    return{level:0,zone:'bleed',title:'已選擇補滿版邊緣，系統會自動抓紅線內側 2mm 鏡射延伸到紅線外側 2mm。',important:false};
  }
  window.__lunyDangerZoneHit=false;
