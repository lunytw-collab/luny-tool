/* LUNY label application preview v5.0.0-materials | package + finished preview | 2026-09-08 */
...
(function installLunyApplicationPreviewStyles(){
  ...
  install("lunyLabelApplicationPreviewMaterialV5Style","\n  .luny-apply-sticker[data-material=\"lowResidueArtpaper\"] .luny-apply-texture{opacity:.055}\n  .luny-apply-sticker[data-material=\"lowResiduePearlescent\"] .luny-apply-texture{opacity:.035}\n  .luny-apply-sticker[data-material=\"lowResiduePearlescent\"] .luny-apply-reflection{opacity:.22}\n  .luny-apply-sticker[data-material=\"glossSilver\"],.luny-apply-sticker[data-material=\"matteSilver\"]{filter:drop-shadow(0 2px 3px rgba(0,0,0,.24))}\n  .luny-apply-sticker[data-material=\"glossSilver\"] .luny-apply-substrate{background:linear-gradient(112deg,#686d72 0%,#d5d8da 17%,#8e9498 31%,#f6f7f7 46%,#8b9195 58%,#e2e4e5 76%,#6f7479 100%)}\n  .luny-apply-sticker[data-material=\"matteSilver\"] .luny-apply-substrate{background:linear-gradient(112deg,#858a8d 0%,#c7cacc 24%,#9ba0a3 46%,#d7d9da 69%,#898e91 100%)}\n  .luny-apply-sticker[data-material=\"glossSilver\"] .luny-apply-art,.luny-apply-sticker[data-material=\"matteSilver\"] .luny-apply-art{opacity:.96;mix-blend-mode:multiply}\n  .luny-apply-sticker[data-material=\"glossSilver\"] .luny-apply-texture,.luny-apply-sticker[data-material=\"matteSilver\"] .luny-apply-texture{opacity:.16;background:repeating-linear-gradient(90deg,rgba(255,255,255,.28) 0,rgba(255,255,255,.28) .5px,rgba(63,68,72,.17) .6px,rgba(63,68,72,.17) 1px,transparent 1.1px,transparent 4px)}\n  .luny-apply-sticker[data-material=\"glossSilver\"] .luny-apply-reflection{opacity:.48;background:linear-gradient(108deg,transparent 8%,rgba(255,255,255,.14) 25%,rgba(255,255,255,.82) 43%,rgba(255,255,255,.10) 57%,transparent 76%)}\n  .luny-apply-sticker[data-material=\"matteSilver\"] .luny-apply-reflection{opacity:.24;background:linear-gradient(108deg,transparent 10%,rgba(255,255,255,.48) 44%,rgba(255,255,255,.08) 62%,transparent 80%)}\n");
...
(function installLunyFinishedMaterialPreview(){
  ...
  function installStyle(){
    ...
    style.textContent+=
      ".luny-finished-material-sticker[data-material=\"lowResidueArtpaper\"] .luny-finished-material-texture{opacity:.055}\n"+
      ".luny-finished-material-sticker[data-material=\"lowResiduePearlescent\"] .luny-finished-material-texture{opacity:.035}\n"+
      ".luny-finished-material-sticker[data-material=\"lowResiduePearlescent\"] .luny-finished-material-reflection{opacity:.22}\n"+
      ".luny-finished-material-sticker[data-material=\"glossSilver\"] .luny-finished-material-substrate{background:linear-gradient(112deg,#686d72 0%,#d5d8da 17%,#8e9498 31%,#f6f7f7 46%,#8b9195 58%,#e2e4e5 76%,#6f7479 100%)}\n"+
      ".luny-finished-material-sticker[data-material=\"matteSilver\"] .luny-finished-material-substrate{background:linear-gradient(112deg,#858a8d 0%,#c7cacc 24%,#9ba0a3 46%,#d7d9da 69%,#898e91 100%)}\n"+
      ".luny-finished-material-sticker[data-material=\"glossSilver\"] .luny-finished-material-art,.luny-finished-material-sticker[data-material=\"matteSilver\"] .luny-finished-material-art{opacity:.96;mix-blend-mode:multiply}\n"+
      ".luny-finished-material-sticker[data-material=\"glossSilver\"] .luny-finished-material-texture,.luny-finished-material-sticker[data-material=\"matteSilver\"] .luny-finished-material-texture{opacity:.16;background:repeating-linear-gradient(90deg,rgba(255,255,255,.28) 0,rgba(255,255,255,.28) .5px,rgba(63,68,72,.17) .6px,rgba(63,68,72,.17) 1px,transparent 1.1px,transparent 4px)}\n"+
      ".luny-finished-material-sticker[data-material=\"glossSilver\"] .luny-finished-material-reflection{opacity:.48;background:linear-gradient(108deg,transparent 8%,rgba(255,255,255,.14) 25%,rgba(255,255,255,.82) 43%,rgba(255,255,255,.10) 57%,transparent 76%)}\n"+
      ".luny-finished-material-sticker[data-material=\"matteSilver\"] .luny-finished-material-reflection{opacity:.24;background:linear-gradient(108deg,transparent 10%,rgba(255,255,255,.48) 44%,rgba(255,255,255,.08) 62%,transparent 80%)}\n";
    document.head.appendChild(style);
  }
  ...
  function renderMaterial(root){
    ...
    var baseNote=typeof api.getMaterialBaseNote==="function"
      ?api.getMaterialBaseNote(material)
      :(api.isNoWhiteInk(material)?"無白墨":"白底材質");
    root.querySelector(".luny-finished-material-name").textContent=api.getMaterialName(material)+"｜"+baseNote;
...
(function(){
  ...
  var metallicMaterials={glossSilver:true,matteSilver:true};
  var materialCache={};
  ...
  function applyMetallicEffect(source,material){
    var cacheKey="metallic|"+material+"|"+source;
    if(materialCache[cacheKey]) return Promise.resolve(materialCache[cacheKey]);
    return loadPreviewImage(source).then(function(image){
      var canvas=document.createElement("canvas");
      canvas.width=image.naturalWidth||image.width;
      ...
      var data=pixels.data;
      var buckets={};
      var step=Math.max(1,Math.floor(Math.max(canvas.width,canvas.height)/72));
      var x,y,index,red,green,blue,luminance,key,bucket;
      for(y=0;y<canvas.height;y+=step){
        for(x=0;x<canvas.width;x+=step){
          ...
          if(luminance<135) continue;
          key=(red>>4)+"|"+(green>>4)+"|"+(blue>>4);
          bucket=buckets[key]||(buckets[key]={count:0,red:0,green:0,blue:0});
          bucket.count++;bucket.red+=red;bucket.green+=green;bucket.blue+=blue;
        }
      }
      var target=null;
      Object.keys(buckets).forEach(function(bucketKey){
        var candidate=buckets[bucketKey];
        if(!target||candidate.count>target.count) target=candidate;
      });
      if(target){
        target={
          red:target.red/target.count,
          green:target.green/target.count,
          blue:target.blue/target.count
        };
      }
      for(var i=0;i<data.length;i+=4){
        ...
        if(target){
          var distance=Math.sqrt(
            Math.pow(red-target.red,2)+
            Math.pow(green-target.green,2)+
            Math.pow(blue-target.blue,2)
          );
          targetAmount=(1-smoothStep(18,78,distance))*smoothStep(80,155,luminance);
        }
        var neutralAmount=(1-smoothStep(10,48,chroma))*smoothStep(205,252,luminance);
        var metallicAmount=Math.max(targetAmount,neutralAmount*.78);
        data[i+3]=Math.round(data[i+3]*(1-metallicAmount*.94));
      }
      context.putImageData(pixels,0,0);
      var processed=canvas.toDataURL("image/png");
      materialCache[cacheKey]=processed;
  ...
  function applyMaterialPreview(root,source){
    ...
    var result=metallicMaterials[material]
      ?applyMetallicEffect(source,material)
      :(noWhiteInkMaterials[material]?removeWhiteInk(source,material):Promise.resolve(source));
  ...
  window.LUNY_LABEL_MATERIAL_PREVIEW={
    version:"5.0.0-four-materials-finished-preview",
    ...
    isMetallic:function(value){return !!metallicMaterials[value||getMaterial()];},
    getMaterialBaseNote:function(value){
      var material=value||getMaterial();
      if(metallicMaterials[material]) return "金屬底材・固定亮膜";
      return noWhiteInkMaterials[material]?"無白墨":"白底材質";
    },
    captureFinalDesign:captureRenderedDesign,
    renderSource:function(source,value){
      var material=value||getMaterial();
      return metallicMaterials[material]
        ?applyMetallicEffect(source,material)
        :(noWhiteInkMaterials[material]?removeWhiteInk(source,material):Promise.resolve(source));
    },
    refresh:function(){
