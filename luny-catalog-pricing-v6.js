/*
  LUNY Catalog Pricing v6
  GitHub filename:
  luny-catalog-pricing-v6.js

  Usage:
  <script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool/luny-catalog-pricing-v6.js?v=20260818-1"></script>
...
(function(){
  ...
  function getOptions(){
    return {
      ...
      sizes: ["A5", "A6", "A7"],
      quantities: [20,30,40,50,60,70,80,90,100,150,200,300,400,500],
      urgents: [
        {
          value: "normal",
          label: "一般件",
