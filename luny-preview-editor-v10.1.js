/* LUNY 預覽主程式整合版 v7.9.29-native-palette-reset
 ...
 * v7.9.29：移除額外滴管按鈕，改用調色盤內建滴管；保留「恢復」按鈕，清除自訂補邊顏色回到原本補邊。
 */
