 ...
 * 檔名：luny-label-step-scroll-20260921b.js
 *
 * 1shop 試算頁底部加一行（可與 conversion-patch c、autofit 並存）：
 * <script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool@main/luny-label-step-scroll-20260921b.js?v=20260921b"></script>
 *
 * 行為：
 * - 選完形狀 → 滑到尺寸
...
(function () {
  ...
  if (window.__LUNY_LABEL_STEP_SCROLL_20260921B__) return;
  window.__LUNY_LABEL_STEP_SCROLL_20260921B__ = true;
  ...
  function injectStyle() {
    if ($("lunyStepScrollStyle20260921b")) return;
    var style = document.createElement("style");
    style.id = "lunyStepScrollStyle20260921b";
    style.textContent =
