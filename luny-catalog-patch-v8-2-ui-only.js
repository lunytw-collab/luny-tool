/*
  ...
  GitHub filename:
  luny-catalog-patch-v8-ui-only.js

  Required load order in 1SHOP:
  1) 原本標籤貼紙模板
  2) luny-catalog-pricing-v4.js
  3) luny-catalog-patch-v8-ui-only.js
  ...
  - Adds rush fee + cutline service fee into saved design payload
*/
...
(function LunyCatalogFromLabelTemplateV8(){
  ...
  const CATALOG_PRICING_SRC = "https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool/luny-catalog-pricing-v4.js?v=20260616-2";
