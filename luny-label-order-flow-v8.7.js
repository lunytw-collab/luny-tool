...
return {assetType,objectName:signed.objectName,fileUrl:signed.fileUrl,bucket:signed.bucket||"",contentType,sizeBytes:blob.size,uploadedAt:new Date().toISOString()};
}
