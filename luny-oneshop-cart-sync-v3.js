...
(function installLunyOneShopCartSync(){
  ...
  window.__LUNY_ONESHOP_CART_SYNC_V3__ = "2026-08-05.3";
  window.__LUNY_ONESHOP_NOTE_AUTOFILL_V2__ = "2026-08-05.3";
  ...
  function isAllowedQtyProductPage(){
    ...
    return ALLOWED_QTY_PRODUCT_IDS.indexOf(id) >= 0 ||
  ...
  function run(){
    ...
    fillNote();
    var meta = getSyncMeta();
    if (!meta.expectedTotal || !isAllowedQtyProductPage()) return;
    fillQty();
  ...
  try {
    observer = new MutationObserver(function(){
      if (!observerSuspended) scheduleRun(90);
    });
