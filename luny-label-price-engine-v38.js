  ...
  */
  ...
  function getSpecQuantityLimitResult(shape, widthCm, heightCm, mappedModule) {
    ...
    return {
      ...
      blocked: true,
      maxQty: 0,
      message: "此形狀與尺寸不符合健豪標準發包規格，請調整尺寸或改選客製形狀"
    };
  }
  ...
  function roundPrice(price) {
    // 最終售價個位數無條件捨去，例如 17,001 → 17,000。
    return Math.floor((Number(price) || 0) / 10) * 10;
  }
  ...
  function calculatePrice() {
    ...
    const total = applyExtraFees(baseTotal, shapeForPricing, urgent, shapeValue, widthCm, heightCm, finalQuantity);
