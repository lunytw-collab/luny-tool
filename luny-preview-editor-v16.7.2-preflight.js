/* LUNY v16.7.2 preflight：補回補邊方案返回操作，並加入危險區局部圖文群聚偵測。 */
...
var LUNY_PREFLIGHT_VERSION='16.7.2';
...
function lunyFlattenedPhotoDangerAssessment(){
  ...
  return{
    danger:broadDanger||localizedDanger,
    hits,samples,ratio,maxSectorRatio,maxWindowRatio,hotSectorCount,
    detection:broadDanger?'broad':(localizedDanger?'localized':'none')
  };
}
