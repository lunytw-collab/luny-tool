/* LUNY 預覽主程式整合版 v7.9.25-canvas-eyedropper
 ...
 * v7.9.25：預覽畫布加入滴管取色；可調取樣範圍，取色後作為補滿版邊緣底色輔助。
 */
...
/* LUNY v7.9.25：移除模式切換 UI；保留畫布上滴管取色工具。 */
(function(){
  function hideModeUI(){
