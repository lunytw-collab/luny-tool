...
/* v9.2-phase5.6-materials：補齊四款標籤貼紙材質的正式訂單名稱。 */
(function(){
  var originalGetMaterialTextValue=getMaterialTextValue;
  getMaterialTextValue=function(value){
    var map={
      lowResidueArtpaper:"低殘膠銅板貼紙",
      lowResiduePearlescent:"低殘膠珠光貼紙",
      glossSilver:"亮銀龍貼紙",
      matteSilver:"消光銀龍貼紙"
    };
    return map[value]||originalGetMaterialTextValue(value);
  };
  window.getMaterialTextValue=getMaterialTextValue;
})();
