...
function drawPreview(){
  ...
  handles=drawAll(ctxG,cG,CM2PX,{includeGuides:showGuides,includeSelection:shape.value!=='custom',showQRTestMark:showQRTest,showMinText:showTestText,isPreview:true,useFullImage:!__lunyInteractiveDraw});
