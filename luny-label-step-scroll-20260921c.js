 ...
 * 檔名：luny-label-step-scroll-20260921c.js
 *
 * 1shop 試算頁底部加一行（可與 conversion-patch c、autofit 並存）：
 * <script src="https://cdn.jsdelivr.net/gh/lunytw-collab/luny-tool@main/luny-label-step-scroll-20260921c.js?v=20260921c"></script>
 *
...
(function () {
  ...
  if (window.__LUNY_LABEL_STEP_SCROLL_20260921C__) return;
  window.__LUNY_LABEL_STEP_SCROLL_20260921C__ = true;
  ...
  function injectStyle() {
    if ($("lunyStepScrollStyle20260921c")) return;
    var style = document.createElement("style");
    style.id = "lunyStepScrollStyle20260921c";
    style.textContent =
