/* LUNY v16.7.3 preflight：統一危險區與印前判定，加入中高密度防漏判與可見版本標示。 */
...
var LUNY_PREFLIGHT_VERSION='16.7.3';
...
function lunyFlattenedPhotoDangerAssessment(){
  ...
  for(let t=0;t<=1.0001;t+=0.2){
    ...
    const pts=sampleShapeBoundaryPoints(ww,hh,150);
  ...
  const broadDanger=samples>=60&&hits>=36&&ratio>=0.55;
  const moderateDenseDanger=samples>=500&&hits>=240&&ratio>=0.43;
  const localizedDanger=samples>=60&&hits>=24&&maxSectorRatio>=0.68&&maxWindowRatio>=0.56;
  return{
